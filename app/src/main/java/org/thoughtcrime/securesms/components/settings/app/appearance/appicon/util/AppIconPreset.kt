...
enum class AppIconPreset(private val componentName: String, @DrawableRes val iconPreviewResId: Int, @StringRes val labelResId: Int) {
  ...
  LIQUID_BLUE(".RoutingActivityAltSignalLiquidBlue", R.drawable.ic_app_icon_signal_liquid_blue_top_preview, R.string.app_icon_label_signal_liquid_blue),
  SIGNAL_BLUE_A(".RoutingActivityAltSignalBlueA", R.drawable.ic_app_icon_signal_icon_blue_a_top_preview, R.string.app_icon_label_signal_blue_a),
  SIGNAL_BLUE_B(".RoutingActivityAltSignalBlueB", R.drawable.ic_app_icon_signal_icon_blue_b_top_preview, R.string.app_icon_label_signal_blue_b),
  LIQUID_DARK(".RoutingActivityAltSignalLiquidDark", R.drawable.ic_app_icon_signal_liquid_dark_top_preview, R.string.app_icon_label_signal_liquid_dark),
  BIG_SUR(".RoutingActivityAltSignalBigSur", R.drawable.ic_app_icon_signal_big_sur_top_preview, R.string.app_icon_label_signal_big_sur);
