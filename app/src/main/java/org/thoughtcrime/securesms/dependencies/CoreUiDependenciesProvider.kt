...
object CoreUiDependenciesProvider : CoreUiDependencies.Provider {
  ...
  override fun provideAppUiMode(): String {
    return SignalStore.settings.appUiMode.serialize()
  }

  override fun provideTextFont(): String {
    return SignalStore.settings.textFont.serialize()
  }

  override fun provideSmoothTransitionsEnabled(): Boolean {
    return SignalStore.settings.isSmoothTransitionsEnabled
  }
}
