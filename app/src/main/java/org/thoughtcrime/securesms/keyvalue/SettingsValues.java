...
public final class SettingsValues extends SignalStoreValues {
  ...
  public static final  String APP_UI_MODE                             = "settings.app.ui.mode";
  public static final  String TEXT_FONT                               = "settings.text.font";
  public static final  String MESSAGE_FONT_SIZE                       = "settings.message.font.size";
  public static final  String CHAT_LIST_VIEW                          = "settings.chat.list.view";
  public static final  String SMOOTH_TRANSITIONS                      = "settings.smooth.transitions";
  ...
  private static final String TWO_STEP_VERIFICATION_ENABLED           = "settings.twoStepVerification.enabled";
  ...
  public @NonNull AppUiMode getAppUiMode() {
    return AppUiMode.deserialize(getString(APP_UI_MODE, AppUiMode.DEFAULT.serialize()));
  }

  public void setAppUiMode(@NonNull AppUiMode appUiMode) {
    putString(APP_UI_MODE, appUiMode.serialize());
    onConfigurationSettingChanged.postValue(APP_UI_MODE);
  }

  public @NonNull TextFont getTextFont() {
    return TextFont.deserialize(getString(TEXT_FONT, TextFont.DEFAULT.serialize()));
  }

  public void setTextFont(@NonNull TextFont textFont) {
    putString(TEXT_FONT, textFont.serialize());
    onConfigurationSettingChanged.postValue(TEXT_FONT);
  }
  ...
  public void setMessageFontSize(int messageFontSize) {
    ...
    onConfigurationSettingChanged.postValue(MESSAGE_FONT_SIZE);
  }

  public @NonNull ChatListView getChatListView() {
    return ChatListView.deserialize(getString(CHAT_LIST_VIEW, ChatListView.COMFORTABLE.serialize()));
  }

  public void setChatListView(@NonNull ChatListView chatListView) {
    putString(CHAT_LIST_VIEW, chatListView.serialize());
    onConfigurationSettingChanged.postValue(CHAT_LIST_VIEW);
  }

  public boolean isSmoothTransitionsEnabled() {
    return getBoolean(SMOOTH_TRANSITIONS, true);
  }

  public void setSmoothTransitionsEnabled(boolean enabled) {
    putBoolean(SMOOTH_TRANSITIONS, enabled);
    onConfigurationSettingChanged.postValue(SMOOTH_TRANSITIONS);
  }
  ...
  public boolean isTwoStepVerificationEnabled() {
    return getBoolean(TWO_STEP_VERIFICATION_ENABLED, false);
  }

  public @Nullable String getTwoStepVerificationEmail() {
    return getString(TWO_STEP_VERIFICATION_EMAIL, null);
  }

  public @Nullable String getTwoStepVerificationPinSalt() {
    return getString(TWO_STEP_VERIFICATION_PIN_SALT, null);
  }

  public @Nullable String getTwoStepVerificationPinHash() {
    return getString(TWO_STEP_VERIFICATION_PIN_HASH, null);
  }

  public void setTwoStepVerification(@NonNull String email, @NonNull String pinSalt, @NonNull String pinHash) {
    getStore().beginWrite()
              .putBoolean(TWO_STEP_VERIFICATION_ENABLED, true)
              .putString(TWO_STEP_VERIFICATION_EMAIL, email)
              .putString(TWO_STEP_VERIFICATION_PIN_SALT, pinSalt)
              .putString(TWO_STEP_VERIFICATION_PIN_HASH, pinHash)
              .apply();
  }

  public void setTwoStepVerificationEmail(@NonNull String email) {
    putString(TWO_STEP_VERIFICATION_EMAIL, email);
  }

  public void setTwoStepVerificationPin(@NonNull String pinSalt, @NonNull String pinHash) {
    getStore().beginWrite()
              .putString(TWO_STEP_VERIFICATION_PIN_SALT, pinSalt)
              .putString(TWO_STEP_VERIFICATION_PIN_HASH, pinHash)
              .apply();
  ...
  public void clearTwoStepVerification() {
    getStore().beginWrite()
              .putBoolean(TWO_STEP_VERIFICATION_ENABLED, false)
              .putString(TWO_STEP_VERIFICATION_EMAIL, null)
              .putString(TWO_STEP_VERIFICATION_PIN_SALT, null)
              .putString(TWO_STEP_VERIFICATION_PIN_HASH, null)
              .apply();
  }
  ...
  public enum AppUiMode {
    DEFAULT("default"), GLASSMORPHISM("glassmorphism"), LIQUID_GLASS("liquid_glass");

    private final String value;

    AppUiMode(String value) {
      this.value = value;
    }
    ...
    public static @NonNull AppUiMode deserialize(@NonNull String value) {
      switch (value) {
        case "default":
          return DEFAULT;
        case "glassmorphism":
  ...
  public enum TextFont {
    ...
    public static @NonNull TextFont deserialize(@NonNull String value) {
      switch (value) {
        case "birthstone":
          return BIRTHSTONE;
        case "emilys_candy":
  ...
  public enum ChatListView {
    COMPACT("compact"), COMFORTABLE("comfortable"), EXPANDED("expanded");

    private final String value;

    ChatListView(String value) {
      this.value = value;
    }
    ...
    public static @NonNull ChatListView deserialize(@NonNull String value) {
      switch (value) {
        case "compact":
          return COMPACT;
        case "expanded":
